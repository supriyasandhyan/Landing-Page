            ...
            <div className={classes["accordion"]}>
                ...
                <div className={classes["accordion-item"]}>
                    <div className={classes["symbol"]}>
                        ...
                        </h2><i className={iconColor2} onClick={hide2} style={{ color: '#4DB8EF' }}></i>
                        </div>
                ...
                <div className={classes["accordion-item"]}>
                    <div className={classes["symbol"]}>
                        ...
                        </h2><i className={iconColor3} onClick={hide3} style={{ color: '#4DB8EF' }}></i>
                        </div>
                ...
                <div className={classes["accordion-item"]}>
                    <div className={classes["symbol"]}>
                        ...
                        </h2><i className={iconColor4} onClick={hide4} style={{ color: '#4DB8EF' }}></i>
                        </div>
                ...
                <div className={classes["accordion-item"]}>
                    <div className={classes["symbol"]}>
                        ...
                        </h2><i className={iconColor5} onClick={hide5} style={{ color: '#4DB8EF' }}></i>
                        </div>
                ...
                <div className={classes["accordion-item"]}>
                    <div className={classes["symbol"]}>
                        ...
                        </h2><i className={iconColor6} onClick={hide6} style={{ color: '#4DB8EF' }}></i>
                        </div>
                ...
                <div className={classes["accordion-item"]}>
                    <div className={classes["symbol"]}>
                        ...
                        </h2><i className={iconColor7} onClick={hide7} style={{ color: '#4DB8EF' }}></i>
                        </div>
